// Package useragentgenerator provides a Go client for the User Agent Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/useragentgenerator?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the User Agent Generator API.
//
// Parameters:
//   - device (required): string - The device type for the user agent string
type Request struct {
...
// ResponseData contains the data returned by the User Agent Generator API.
type ResponseData struct {
	Ua string `json:"ua"`
	Browser BrowserData `json:"browser"`
...
// BrowserData represents the browser object.
...
// EngineData represents the engine object.
type EngineData struct {
	Name string `json:"name"`
	Version string `json:"version"`
}

// OsData represents the os object.
type OsData struct {
	Name string `json:"name"`
	Version string `json:"version"`
}

// DeviceData represents the device object.
type DeviceData struct {
	Vendor string `json:"vendor"`
	Model string `json:"model"`
}

// CpuData represents the cpu object.
type CpuData struct {
