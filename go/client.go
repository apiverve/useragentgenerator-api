...
const (
	baseURL        = "https://api.apiverve.com/v1/useragentgenerator"
	defaultTimeout = 30 * time.Second
)

// Client is the User Agent Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new User Agent Generator API client.
...
// Execute makes a request to the User Agent Generator API with typed parameters.
//
