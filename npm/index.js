...
class useragentgeneratorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/useragentgenerator');
        }
        ...
        this.validationRules = {"device":{"type":"string","required":true,"default":"desktop"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/useragentgenerator`);
        }
    }
...
module.exports = useragentgeneratorWrapper;
