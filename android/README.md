# User Agent Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:useragentgenerator-api:1.1.13'
}
```
...
```java
import com.apiverve.useragentgenerator.UserAgentGeneratorAPIClient;
import com.apiverve.useragentgenerator.APIResponse;
import com.apiverve.useragentgenerator.APIException;

// Initialize the client
UserAgentGeneratorAPIClient client = new UserAgentGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/useragentgenerator](https://docs.apiverve.com/ref/useragentgenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/useragentgenerator](https://docs.apiverve.com/ref/useragentgenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/useragentgenerator-api/issues)
