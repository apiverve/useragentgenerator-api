...
{
    class UserAgentGeneratorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/useragentgenerator";

        /// <summary>
        /// Make a GET request to the User Agent Generator API
        /// </summary>
        static async Task<JsonDocument> CallUserAgentGeneratorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;device&quot;] &#x3D; &quot;desktop&quot; };
        ...
        {
            Console.WriteLine("📤 Calling User Agent Generator API...\n");

            var result = await CallUserAgentGeneratorAPI();
